  ...
  return (
    <Section tone="white">
      ...
      <Reveal className="mt-9 sm:mt-12" delay={0.1}>
        <p className="font-outfit font-semibold tracking-[-0.02em] leading-[1.3] text-[19px] sm:text-[28px] text-[#0b1533] max-w-[34ch]">
          Your employees don't need another webinar.
          <span className="block font-medium text-[0.8em] text-[#6b7597] mt-2">
